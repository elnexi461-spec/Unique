...
const STATS_HERO = [
  ...
  { value: "500+",  label: "Scholarships Awarded Annually" },
...
const STUDENT_LIFE_ITEMS = [
  {
    title: "Internships & Career Support",
    desc: "Real-world experience with top organisations across Africa and beyond.",
    img: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=700&q=80",
  },
  {
    title: "Global Community & Culture",
    desc: "A vibrant, diverse campus culture that celebrates every background.",
    img: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=700&q=80",
  },
  {
    title: "Fun & Engaging Learning",
    desc: "Interactive lectures, group projects, and innovation challenges.",
...
const NEWS = [
  {
    id: 1, category: "Scholarship 2026",
    title: "UOU announces 50 full-tuition scholarships for top Vanguard scholars — applications open now",
    date: "May 2026",
  },
  {
    id: 2, category: "Scholarship 2026",
    title: "Merit-based Excellence Awards: ₦2.5M pool for highest Gold Card earners this semester",
    date: "May 2026",
  },
  {
    id: 3, category: "AI Update",
    title: "Vanguard Guardian AI module launched — personal performance diagnostics for every scholar",
    date: "May 2026",
  },
  {
    id: 4, category: "Academic",
    title: "Week 18 Friday Brief: Zaria Center achieves 15% punctuality surge under Sentinel optimisation",
    date: "May 2026",
  },
];
        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-5 h-16 flex items-center justify-between">
              ...
              <button onClick={() => scrollTo("/")} className="flex items-center gap-3 group">
                ...
                <span className="hidden sm:block text-white font-black text-lg leading-tight">
                  Unique Open<br />
                  <span style={{ color: C.electric }}>University</span>
                </span>
              </button>
              ...
              <div className="flex items-center gap-3">
                <Link href="/login">
                  <Button
                    size="sm"
                    className="hidden sm:flex h-9 px-5 font-bold text-white border-0"
                    style={{
                  ...
                  <div className="p-5 space-y-3 border-t" style={{ borderColor: C.border }}>
                    ...
                    <Link href="/login" onClick={() => setMenuOpen(false)}>
                      <Button variant="outline" className="w-full font-semibold"
                        style={{ borderColor: C.border, color: C.electric }}>
                        Student Login
                      </Button>
                    </Link>
                    <button
                      onClick={() => { setMenuOpen(false); setPhase("persona"); }}
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, rgba(4,11,26,0.72) 0%, rgba(4,17,42,0.82) 50%, rgba(4,11,26,0.96) 100%)",
              }}
            />
                ...
                <motion.h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight text-white leading-none">
                  {["Unique", "Open", "University"].map((word, wi) => (
                    <motion.span
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.15 + wi * 0.15, duration: 0.7, ease: [0.22, 1, 0.36, 1] }}
                      style={{
              ...
              >
                <Link href="/login">
                  <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
                    <Button
                      size="lg"
                      className="h-13 px-8 text-base font-black text-white border-0"
                      style={{
                        background: `linear-gradient(135deg, ${C.gold}, #D97706)`,
                ...
                <motion.button
                  ...
                  className="h-13 px-6 text-sm font-medium text-white/50 hover:text-white/80 transition-colors"
                >
                  Demo Mode →
                </motion.button>
              </motion.div>
          ...
          <section
            ...
            style={{ background: "rgba(6,14,38,0.8)" }}
          >
            <div className="max-w-6xl mx-auto">
                ...
                {[
                  {
                    icon: "🎯",
                    title: "Our Mission",
                    body: "To provide affordable, high-quality, and flexible education that empowers individuals to achieve their academic and career goals, regardless of location or circumstance.",
                  },
                  {
                    icon: "🏛️",
                    title: "Our Vision",
                    body: "To build a leading global open university where learning knows no boundaries — connecting Nigeria and Africa to the world through knowledge and innovation.",
                  },
                ].map((card, i) => (
                  <motion.div
                    key={card.title}
              ...
              {/* Stats row */}
              <div
                className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-10 rounded-2xl p-8"
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <motion.div
                  ...
                  style={{
                    background: "linear-gradient(160deg, rgba(30,58,138,0.9) 0%, rgba(15,23,80,0.95) 100%)",
                ...
                >
                  ...
                  <div className="relative z-10 p-7">
                    ...
                    <div className="space-y-2">
                      {DEGREE_PROGRAMS.map((prog, i) => (
                        <motion.button
                          ...
                          style={{
                            borderColor: i === 0 ? "rgba(147,197,253,0.5)" : "rgba(59,130,246,0.2)",
                            background: i === 0 ? "rgba(147,197,253,0.15)" : "rgba(29,78,216,0.08)",
                          }}
                        >
                          {prog}
                    ...
                    <Link href="/login">
                      <button
                        className="mt-5 w-full flex items-center justify-center gap-2 py-3 rounded-xl border text-sm font-bold text-white transition-all hover:bg-white/5"
                ...
                >
                  ...
                  <Link href="/login">
                    <button
                      className="mt-5 w-full flex items-center justify-center gap-2 py-3 rounded-xl border text-sm font-bold text-white transition-all hover:bg-white/10"
                    ...
                    <div className="space-y-2">
                      {TECH_PROGRAMS.map((prog, i) => (
                        <motion.button
                          ...
                          className="w-full flex items-center justify-between px-4 py-3 rounded-lg border text-left text-sm font-medium text-white transition-all"
                          style={{
                            borderColor: i === 3 ? "rgba(147,197,253,0.4)" : "rgba(59,130,246,0.22)",
                            background: i === 3 ? "rgba(147,197,253,0.12)" : "rgba(29,78,216,0.08)",
                          }}
                        >
                          {prog}
                          <ChevronRight size={14} className="opacity-50 shrink-0" />
          ...
          <section
            id="student-life"
            className="py-24 px-6"
            style={{ background: "rgba(6,14,38,0.85)" }}
          >
            <div className="max-w-6xl mx-auto">
              <motion.div
                initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                {STUDENT_LIFE_ITEMS.map((item, i) => (
                  ...
                  >
                    ...
                    <div className="relative rounded-2xl overflow-hidden aspect-[16/7]">
                      ...
                      <div
                        className="absolute inset-0"
                        style={{ background: "linear-gradient(to top, rgba(4,11,26,0.6) 0%, transparent 60%)" }}
                      />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                >
                  <svg viewBox="0 0 100 100" className="w-full h-full opacity-20 absolute inset-0">
                    <path
                      d="M20,30 L30,20 L50,18 L65,22 L75,28 L80,40 L75,55 L65,68 L55,75 L40,78 L28,70 L22,58 L18,45 Z"
                    ...
                    >
                      <div className="relative">
                        ...
                        <div
                          ...
                          style={{
                            background: c.active ? C.electric : "#2d3a5e",
                            borderColor: c.active ? C.glow : "#3d4d7e",
                ...
                <div className="space-y-3">
                  {CAMPUS_CENTERS.map((c, i) => (
                    <motion.div
                      ...
                      style={{
                        background: hoveredCenter === c.id ? "rgba(29,78,216,0.12)" : C.card,
                        borderColor: hoveredCenter === c.id ? "rgba(59,130,246,0.4)" : C.border,
                      }}
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{
                          background: c.active ? "rgba(29,78,216,0.12)" : "rgba(80,80,100,0.1)",
                          color: c.active ? C.electric : "#666",
            ...
            <div className="max-w-3xl mx-auto text-center relative z-10">
              ...
              >
                ...
                <p className="text-white/75 text-lg mb-10 leading-relaxed">
                  ...
                  international students to ensure that financial constraints do not hinder
                  academic pursuits.
                </p>
                <Link href="/login">
                  <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
                    <Button
                      size="lg"
                      className="h-13 px-10 font-bold text-white border-0"
          ...
          <section
            id="fees"
            className="py-24 px-6"
            style={{ background: "rgba(6,14,38,0.9)" }}
          >
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                {/* Left: Affordable fees */}
                <motion.div
                  initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                >
                  ...
                  <Link href="#contact">
                    <Button
                      size="lg"
                      className="font-bold text-white border-0 mb-8"
                      style={{ background: C.brand }}
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {["Affordable Tuition", "Flexible Installment Plans", "Scholarships Available", "No Hidden Charges"].map(benefit => (
                        <div key={benefit} className="flex items-center gap-3 text-white/85">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      <span
                        ...
                        style={{ background: "rgba(29,78,216,0.15)", color: C.electric }}
                      >
                        {item.category}
                      </span>
              ...
              <div className="flex items-center justify-center gap-4 flex-wrap">
                <Link href="/login">
                  <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
                    <Button
                      size="lg"
                      className="h-14 px-12 text-lg font-black text-white border-0"
                      style={{
                        background: `linear-gradient(135deg, ${C.gold}, #D97706)`,
                ...
                <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="h-14 px-12 text-lg font-black"
                    style={{ borderColor: "rgba(59,130,246,0.4)", color: C.electric }}
                  >
          ...
          >
            <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <MapPin size={16} className="shrink-0 mt-0.5" style={{ color: C.electric }} />
                      <p className="text-sm text-white/40 leading-relaxed">
                        Unique Open University<br />
                        Zaria, Kaduna State, Nigeria<br />
                        (Also in Lagos &amp; Kano)
                      </p>
                    </div>
                    <div className="flex items-center gap-3">
                      <Phone size={16} className="shrink-0" style={{ color: C.electric }} />
                      <a href="tel:+2348012345678" className="text-sm text-white/40 hover:text-white/70 transition-colors">
                        +234 801 234 5678
                      </a>
                    </div>
                    <div className="flex items-center gap-3">
                      <Mail size={16} className="shrink-0" style={{ color: C.electric }} />
                      <a href="mailto:info@uou.edu.ng" className="text-sm text-white/40 hover:text-white/70 transition-colors">
                        info@uou.edu.ng
                      </a>
                    </div>
                    <div className="flex items-center gap-3">
                      <Globe size={16} className="shrink-0" style={{ color: C.electric }} />
                      <a href="https://uou.edu.ng" target="_blank" rel="noopener noreferrer"
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  {["Privacy Policy", "Terms of Use", "Cookie Policy"].map(item => (
                    <button key={item} className="text-xs text-white/25 hover:text-white/50 transition-colors">
                      {item}
                    </button>
                  ))}
                </div>
              ...
              {/* Iron Curtain auth note */}
              <p className="text-center text-xs text-white/20 mt-4">
                Student portal access is by invitation only.{" "}
                <Link href="/login">
                  <span className="underline hover:text-white/40 transition-colors cursor-pointer">
