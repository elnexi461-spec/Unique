...
/** Fade up with configurable delay */
const fu = (delay = 0, y = 64) => ({
  initial:     { opacity: 0, y },
      ...
      {phase === "landing" && (
        ...
        >
          ...
          <header
            ...
            style={{
              background: scrolled ? "rgba(4,11,26,0.95)" : "transparent",
                ...
                >
                  ...
                  <div className="p-5 space-y-3 border-t" style={{ borderColor: C.border }}>
                    <Link href="/login" onClick={() => setMenuOpen(false)}>
                      <Button className="w-full font-bold text-white border-0"
                        style={{ background: `linear-gradient(135deg, ${C.gold}, #D97706)` }}>Apply Now</Button>
                    </Link>
                    <Link href="/login" onClick={() => setMenuOpen(false)}>
                      <Button variant="outline" className="w-full font-semibold"
                        style={{ borderColor: C.border, color: C.electric }}>Student Login</Button>
                    </Link>
          ...
          <motion.section style={{ y: heroY, opacity: heroOpacity }}
            ...
            <div className="text-center max-w-5xl relative z-10">
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.1 }}
                ...
                <motion.img src={import.meta.env.BASE_URL + "uou-logo.png"} alt="Unique Open University"
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25, duration: 0.6, ease: EASE_CINEMATIC }}
                ...
                <motion.h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight leading-none">
                  {["Unique", "Open", "University"].map((word, wi) => (
                    <motion.span key={word}
                      ...
                      transition={{ delay: 0.35 + wi * 0.18, duration: 0.85, ease: EASE_CINEMATIC }}
                      style={{
                        display: "inline-block", marginRight: wi < 2 ? "0.3em" : 0,
                        color: word === "Open" ? C.electric : "white",
                        textShadow: word === "Open" ? "0 0 60px rgba(59,130,246,0.5)" : undefined,
                      }}>
                      {word}
                    </motion.span>
                  ))}
              ...
              <motion.p initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.72, duration: 0.7, ease: EASE_CINEMATIC }}
              ...
              <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.88, duration: 0.6, ease: EASE_CINEMATIC }}
              ...
              <div className="flex items-center justify-center gap-8 flex-wrap">
                {STATS_HERO.map((s, i) => (
                  <motion.div key={s.label}
                    ...
                    transition={{ delay: 1.0 + i * 0.1, duration: 0.6, ease: EASE_CINEMATIC }}
          ...
          <section id="about" className="py-24 px-6" style={{ background: "rgba(6,14,38,0.8)" }}>
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-4">
                <SectionLabel>About UOU</SectionLabel>
                <motion.h2 {...fu(0.1)} className="text-4xl md:text-5xl font-black text-white mb-4">
                  Our Mission
                </motion.h2>
                <motion.p {...fu(0.2, 40)}
                  className="text-lg text-white/65 max-w-3xl mx-auto leading-relaxed">
                  ...
                  we are your trusted path to professional excellence. Knowledge for global impact.
                </motion.p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-14">
                {[
                  ...
                  <motion.div key={card.title} {...(i === 0 ? sl(0.08) : sr(0.08))}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-10 rounded-2xl p-8"
                ...
                {[
                  ...
                  <motion.div key={s.label} {...fu(0.1 + i * 0.12)} className="text-center">
          ...
          <section id="programs" className="py-24 px-6" style={{ background: C.navy }}>
            <div className="max-w-6xl mx-auto">
              <div className="mb-14">
                ...
                <motion.h2 {...fu(0.1)} className="text-4xl md:text-5xl font-black text-white">
                  Our Programs
                </motion.h2>
                <motion.p {...fu(0.2, 30)} className="mt-3 text-white/55 text-lg max-w-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <motion.div {...sl(0)}
                  ...
                  <div className="relative z-10 p-7">
                    ...
                    <div className="space-y-2">
                      {DEGREE_PROGRAMS.map((prog, i) => (
                        <motion.button key={prog}
                          ...
                          viewport={VP} transition={{ delay: 0.08 * i, duration: 0.5, ease: EASE_CINEMATIC }}
                          whileHover={{ x: 5 }}
                    ...
                    <Link href="/login">
                      <button className="mt-5 w-full flex items-center justify-center gap-2 py-3 rounded-xl border text-sm font-bold text-white transition-all hover:bg-white/5"
                ...
                <motion.div {...fu(0.12)}
                  ...
                  <div className="space-y-2">
                    {PROFESSIONAL_PROGRAMS.map((prog, i) => (
                      <motion.button key={prog}
                        ...
                        viewport={VP} transition={{ delay: 0.08 * i, duration: 0.5, ease: EASE_CINEMATIC }}
                        whileHover={{ x: 5 }}
                        className="w-full flex items-center justify-between px-4 py-3 rounded-lg border text-left text-sm font-medium text-white transition-all hover:bg-white/5"
                  ...
                  <Link href="/login">
                    <button className="mt-5 w-full flex items-center justify-center gap-2 py-3 rounded-xl border text-sm font-bold text-white transition-all hover:bg-white/10"
          ...
          <section id="student-life" className="py-24 px-6" style={{ background: "rgba(6,14,38,0.85)" }}>
            <div className="max-w-6xl mx-auto">
              <div className="mb-14">
                <motion.h2 {...fu(0)} className="text-4xl md:text-5xl font-black text-white mb-3">
                  Student Life
                  <span className="inline-block ml-3 text-yellow-400" style={{ fontFamily: "serif" }}>✦</span>
                </motion.h2>
                <motion.p {...fu(0.12, 30)} className="text-white/60 text-lg max-w-xl">
              ...
              <div className="space-y-12">
                {STUDENT_LIFE_ITEMS.map((item, i) => (
                  <motion.div key={item.title} {...fu(0, 50)} viewport={{ once: true, margin: "-60px" }}>
                    <motion.button
                      {...fu(0, 20)}
                      className="w-full text-left flex items-center justify-between pb-3 border-b mb-4 group"
                      style={{ borderColor: "rgba(59,130,246,0.2)" }}>
                      <span className="text-xl font-bold text-white group-hover:text-blue-400 transition-colors">{item.title}</span>
                    ...
                    <motion.div
                      ...
                      <div className="absolute bottom-4 left-6 right-6">
                        <motion.p
                          ...
                          viewport={VP} transition={{ delay: 0.18 + i * 0.05, duration: 0.6, ease: EASE_CINEMATIC }}
          ...
          <section className="py-24 px-6" style={{ background: C.navy }}>
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <motion.h2 {...fu(0.1)} className="text-4xl font-bold text-white mb-4">
                  Campus Center Locator
                </motion.h2>
                <motion.p {...fu(0.2, 24)} className="text-white/50 text-lg">
                  Active learning hubs across Nigeria.
                </motion.p>
              </div>
          ...
          <section className="relative py-28 px-6 overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto text-center relative z-10">
              ...
              <motion.h2 {...fu(0.1)} className="text-4xl md:text-5xl font-black text-white mb-6">
                Scholarships &amp; Financial Aid
              </motion.h2>
              <motion.p {...fu(0.2, 32)} className="text-white/75 text-lg mb-10 leading-relaxed">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div>
                  ...
                  <motion.h2 {...fu(0.08)} className="text-4xl font-black text-white mb-4">
                    Affordable &amp; Flexible Fees
                  </motion.h2>
                  <motion.p {...fu(0.16, 32)} className="text-white/60 mb-8 leading-relaxed">
                    We believe in making education accessible. Our fees are designed to fit your
                    budget, with flexible payment plans and special discounts available.
                  </motion.p>
                  <motion.div {...fu(0.24)}>
                    <Button size="lg" className="font-bold text-white border-0 mb-8"
                      style={{ background: C.brand }}
                  ...
                  <motion.div {...sl(0.3)}
                    ...
                    <div className="space-y-3">
                      {["Affordable Tuition", "Flexible Installment Plans", "Scholarships Available", "No Hidden Charges"].map((benefit, i) => (
                        <motion.div key={benefit}
                          initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }}
                          viewport={VP} transition={{ delay: 0.35 + i * 0.1, duration: 0.5, ease: EASE_CINEMATIC }}
                ...
                <motion.div {...sr(0.1)}>
                  <div className="rounded-2xl border overflow-hidden"
                    ...
                    <div className="relative h-44 overflow-hidden">
                      <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=900&q=80"
                        alt="UOU campus" className="w-full h-full object-cover" />
                        ...
                        <div className="space-y-3">
                          {FEES.map((fee, i) => (
                            <motion.div key={fee.label}
                              initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }}
                              viewport={VP} transition={{ delay: 0.15 + i * 0.09, duration: 0.5, ease: EASE_CINEMATIC }}
              ...
              <div className="flex items-end justify-between mb-12">
                <div>
                  <motion.div {...fu(0)}
                    ...
                    style={{ color: C.electric }}>
                    Live Intelligence Feed
                  </motion.div>
                  <motion.h2 {...fu(0.1)} className="text-4xl font-bold text-white mb-1">
                    Latest News &amp; Articles
                  </motion.h2>
                  <motion.p {...fu(0.18, 20)} className="text-white/50 text-sm">
                    Latest from Unique Open University
                  </motion.p>
                </div>
                <motion.div {...sc(0.2)}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {NEWS.map((item, i) => (
                  <motion.article key={item.id}
                    ...
                    transition={{ delay: i * 0.12, duration: 0.75, ease: EASE_CINEMATIC }}
                    whileHover={{ y: -6 }}
          ...
          <section className="py-24 px-6" style={{ background: "rgba(6,14,38,0.85)" }}>
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <motion.h2 {...fu(0)} className="text-4xl font-bold text-white mb-4">
                  Four Portals, One System
                </motion.h2>
                <motion.p {...fu(0.1, 24)} className="text-white/50 text-lg">
                  Each role gets a bespoke command interface.
                </motion.p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <motion.div key={r.title}
                    ...
                    viewport={{ once: true, margin: "-60px" }}
                    transition={{ delay: i * 0.13, duration: 0.75, ease: EASE_CINEMATIC }}
          ...
          <section className="py-28 px-6 text-center relative overflow-hidden">
            ...
            <div className="max-w-2xl mx-auto relative z-10">
              <motion.div {...sc(0)} className="flex justify-center mb-6">
                <Award size={40} style={{ color: C.gold }} className="gold-glow" />
              </motion.div>
              <motion.h2 {...fu(0.1)} className="text-5xl font-black text-white mb-4 leading-tight">
                Ready to Begin Your Journey?
              </motion.h2>
              <motion.p {...fu(0.2, 28)} className="text-white/50 mb-10 text-lg">
          ...
          <footer id="contact" className="border-t"
            ...
            <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                ...
                {/* Brand */}
                <motion.div {...sl(0)} className="lg:col-span-1">
                ...
                <motion.div {...fu(0.08)}>
                  ...
                  <ul className="space-y-2">
                    {["About Us", "Our Programs", "Admissions", "Tuition & Fees", "Student Life", "Scholarships"].map((link, i) => (
                      <motion.li key={link}
                        initial={{ opacity: 0, x: -12 }} whileInView={{ opacity: 1, x: 0 }}
                        viewport={VP} transition={{ delay: 0.12 + i * 0.06, duration: 0.45, ease: EASE_CINEMATIC }}>
                        <button
                ...
                <motion.div {...fu(0.16)}>
                  ...
                  <ul className="space-y-2">
                    {["Business Administration", "Computer Science", "Nursing Science", "Project Management", "AI & Robotics", "Ethical Hacking"].map((prog, i) => (
                      <motion.li key={prog}
                        initial={{ opacity: 0, x: -12 }} whileInView={{ opacity: 1, x: 0 }}
                        viewport={VP} transition={{ delay: 0.2 + i * 0.06, duration: 0.45, ease: EASE_CINEMATIC }}>
                        <Link href="/login">
                ...
                <motion.div {...sr(0.08)}>
                  ...
                  <div className="space-y-4">
                    {[
                      { Icon: MapPin, content: <p className="text-sm text-white/40 leading-relaxed">Unique Open University<br />Zaria, Kaduna State, Nigeria<br />(Also in Lagos &amp; Kano)</p> },
                      { Icon: Phone, content: <a href="tel:+2348012345678" className="text-sm text-white/40 hover:text-white/70 transition-colors">+234 801 234 5678</a> },
                      { Icon: Mail,  content: <a href="mailto:info@uou.edu.ng" className="text-sm text-white/40 hover:text-white/70 transition-colors">info@uou.edu.ng</a> },
                      { Icon: Globe, content: <a href="https://uou.edu.ng" target="_blank" rel="noopener noreferrer" className="text-sm text-white/40 hover:text-white/70 transition-colors">www.uou.edu.ng</a> },
                    ].map(({ Icon, content }, i) => (
                      <motion.div key={i}
                        initial={{ opacity: 0, x: 16 }} whileInView={{ opacity: 1, x: 0 }}
                        viewport={VP} transition={{ delay: 0.12 + i * 0.08, duration: 0.5, ease: EASE_CINEMATIC }}
