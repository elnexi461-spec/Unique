      ...
      <div className="space-y-6 pb-8">
        ...
        {netBalance > 0 && (
          <motion.div
            ...
            className="rounded-2xl border p-4 flex items-start gap-3 relative overflow-hidden"
            style={{ background: "rgba(248,113,113,0.07)", borderColor: "rgba(248,113,113,0.3)" }}
          >
            <motion.div
              animate={{ opacity: [0.06, 0.14, 0.06] }} transition={{ duration: 2.5, repeat: Infinity }}
              className="absolute inset-0 pointer-events-none"
              style={{ background: "linear-gradient(135deg, rgba(248,113,113,0.12), transparent 60%)" }}
            />
            <AlertTriangle size={16} className="mt-0.5 shrink-0 relative z-10" style={{ color: "#F87171" }} />
