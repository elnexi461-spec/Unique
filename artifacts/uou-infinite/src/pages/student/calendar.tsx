...
import { ArrowLeft, Calendar, Clock, BookOpen, Award, AlertTriangle } from "lucide-react";
...
const TYPE_CONFIG: Record<string, { color: string; bg: string; border: string; label: string }> = {
  ...
  admin:     { color: "#60A5FA", bg: "rgba(96,165,250,0.08)", border: "rgba(96,165,250,0.25)", label: "Admin"     },
            ...
            {SEMESTER_EVENTS.map((ev, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-xs font-mono text-muted-foreground w-16 shrink-0 mt-0.5">Wk {ev.week}</div>
