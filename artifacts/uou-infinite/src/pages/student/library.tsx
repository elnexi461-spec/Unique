...
// All dept colors use Electric Blue palette — no off-brand teal
      ...
      <div className="space-y-6 pb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      {r.available || isBorrowed ? (
                        <>
                          <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}
                            ...
                            style={{
                              background:  isBorrowed ? "rgba(52,211,153,0.15)" : "rgba(0,112,255,0.12)",
                              color:       isBorrowed ? "#34D399" : "#0070FF",
                              border:     `1px solid ${isBorrowed ? "rgba(52,211,153,0.3)" : "rgba(0,112,255,0.3)"}`,
                            }}>
          ...
          <div className="space-y-4">
              ...
              <motion.div key={i}
                ...
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-bold px-2 py-0.5 rounded"
                    style={{
                      background: j.access === "Full" ? "rgba(52,211,153,0.12)" : "rgba(245,158,11,0.12)",
                      color:      j.access === "Full" ? "#34D399" : "#F59E0B",
                    }}>
                    {j.access} Access
                  </span>
                </div>
            ...
            <div className="text-xs font-bold uppercase tracking-[0.2em] text-muted-foreground mt-6">Your Loans</div>
            {borrowed.size === 0 ? (
